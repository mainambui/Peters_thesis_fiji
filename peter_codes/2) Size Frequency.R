...
ggsave("figures/SizeFrequency_Overall.png", p_overall, width = 8, height = 5, dpi = 400)
ggsave("figures/SizeFrequency_ByFamily.png", p_family, width = 10, height = 8, dpi = 400)